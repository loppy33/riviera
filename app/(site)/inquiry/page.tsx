        ...
        <div className="inquiry-card">
          ...
          <div className="inquiry-channels">
            <div className="inquiry-channels__item inquiry-channels__item--email">
              ...
              <p className="inquiry-channels__value">concierge@rivieraestates.com</p>
            </div>
            ...
            <div className="inquiry-channels__item inquiry-channels__item--phone">
              ...
              <p className="inquiry-channels__value">+33 4 93 00 00 00</p>
            </div>
          </div>
          ...
          <form className="inquiry-form">
            ...
            <div className="form-group">
              ...
              <textarea 
                rows={5} 
                placeholder="Tell us about your architectural preferences and desired locations..."
              ></textarea>
            </div>
